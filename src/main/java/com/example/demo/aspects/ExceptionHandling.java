...
public class ExceptionHandling {
    ...
    public
    ResponseEntity<Object> contentValidation(MethodArgumentNotValidException exception) {
    ...
    public ResponseEntity<Object> retriveValidation(DuplicateEmailException exception) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDate.now());
